# Links to project
WandB https://wandb.ai/bernardo_sandi_morales/nyc_airbnb/overview?workspace=user-bernardo_sandi_morales

Git Repo https://github.com/BernardoSandiQB/build-ml-pipeline-for-short-term-rental-prices
